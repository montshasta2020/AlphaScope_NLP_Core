...
df = pd.read_csv("data/dsi-web-slim_v7.csv")
model = KeyedVectors.load_word2vec_format('data/dsi_model_format_v4.bin')
...
def input_form_post():
    ...
    for i in ret[start:end]:
        ...
        summary.append(df.iloc[i]['summary'].decode('utf-8'))
        cnt += 1
...
def dsi_ds():
    ...
    if (key_word_search):
        ...
        ret = df['dsi_w2vs_sim'].values.argsort()[::-1]
    more_ret = ret
    ...
    if (key_word_search):
        return render_template('query_result.html', title = u'Data Science', urls_out = urls, titles_out = titles, summary_out=summary) 
    else:
         return render_template('query_result_subject.html', title = u'Data Science', urls_out = urls, titles_out = titles, summary_out=summary) 
...
def dsi_bd():
    ...
    if (key_word_search):
        ...
        ret = df['bd_w2vs_sim'].values.argsort()[::-1]
    more_ret = ret
    ...
    if (key_word_search):
        return render_template('query_result.html', title = u'Big Data', urls_out = urls, titles_out = titles, summary_out=summary) 
    else:
         return render_template('query_result_subject.html', title = u'Big Data', urls_out = urls, titles_out = titles, summary_out=summary) 
...
def dsi_news():
    ...
    if (key_word_search):
        ...
        ret = df['dsn_w2vs_sim'].values.argsort()[::-1]
    more_ret = ret
    ...
    if (key_word_search):
        return render_template('query_result.html', title = u'Data Science News', urls_out = urls, titles_out = titles, summary_out=summary) 
    else:
         return render_template('query_result_subject.html', title = u'Data Science News', urls_out = urls, titles_out = titles, summary_out=summary) 
...
def dsi_ml():
    ...
    if (key_word_search):
        ...
        ret = df['ml_w2vs_sim'].values.argsort()[::-1]
    more_ret = ret
    ...
    if (key_word_search):
        return render_template('query_result.html', title = u'Machine Learning', urls_out = urls, titles_out = titles, summary_out=summary) 
    else:
         return render_template('query_result_subject.html', title = u'Machine Learning', urls_out = urls, titles_out = titles, summary_out=summary) 
...
def dsi_dm():
    ...
    if (key_word_search):
        ...
        ret = df['dm_w2vs_sim'].values.argsort()[::-1]
    more_ret = ret
    ...
    if (key_word_search):
        return render_template('query_result.html', title = u'Data Mining', urls_out = urls, titles_out = titles, summary_out=summary) 
    else:
         return render_template('query_result_subject.html', title = u'Data Mining', urls_out = urls, titles_out = titles, summary_out=summary) 
...
def dsi_an():
    ...
    if (key_word_search):
        ...
        ret = df['an_w2vs_sim'].values.argsort()[::-1]
    more_ret = ret
    ...
    if (key_word_search):
        return render_template('query_result.html', title = u'Analytics', urls_out = urls, titles_out = titles, summary_out=summary) 
    else:
         return render_template('query_result_subject.html', title = u'Analytics', urls_out = urls, titles_out = titles, summary_out=summary) 
...
def dsi_jobs():
    ...
    if (key_word_search):
        ...
        ret = df['dsj_w2vs_sim'].values.argsort()[::-1]
    more_ret = ret
    ...
    if (key_word_search):
        return render_template('query_result.html', title = u'Data Science Jobs', urls_out = urls, titles_out = titles, summary_out=summary) 
    else:
         return render_template('query_result_subject.html', title = u'Data Science Jobs', urls_out = urls, titles_out = titles, summary_out=summary) 
